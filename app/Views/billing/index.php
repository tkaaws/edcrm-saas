    ...
    <?php else: ?>
        ...
        <div class="detail-grid">
            <article class="detail-card">
                ...
                <?php if (in_array($roleCode ?? '', ['tenant_owner', 'tenant_admin'], true)): ?>
                    <div style="margin-top:1rem;padding-top:1rem;border-top:1px solid var(--line);">
                        <p class="module-subtitle">Plan upgrades, renewals, and feature changes are handled by the EDCRM team.</p>
                    </div>
                <?php endif; ?>
            </article>
            ...
            <article class="detail-card detail-card--wide">
                ...
                <p class="module-subtitle" style="margin-bottom:1rem;">Only features included in your plan are available in this workspace.</p>
