...
<section class="module-page">
    ...
    <form class="form-card form-stack" method="post" action="<?= esc($formAction) ?>">
            ...
            <div class="form-grid">
                ...
                <label class="field">
                    ...
                    <select name="source_id" required>
                        ...
                        <?php $selected = (int) old('source_id', $enquiry->source_id ?? 0); ?>
                ...
                <label class="field">
                    ...
                    <select name="primary_course_id" required>
                        ...
                        <?php $selected = (int) old('primary_course_id', $enquiry->primary_course_id ?? 0); ?>
                ...
                <label class="field">
                    ...
                    <select name="college_id" required>
                        ...
                        <?php $selected = (int) old('college_id', $enquiry->college_id ?? 0); ?>
                        <?php foreach ($colleges as $row): ?>
                            <option value="<?= (int) $row->id ?>" <?= $selected === (int) $row->id ? 'selected' : '' ?>>
                ...
                <label class="field">
                    ...
                    <select name="qualification_id">
                        ...
                        <?php $selected = (int) old('qualification_id', $enquiry->qualification_id ?? 0); ?>
        ...
        <?php if (! empty($showAssignmentSection)): ?>
            <section class="form-card form-card--nested">
                <div class="form-section-header">
                ...
                <div class="form-grid">
                    <label class="field">
                        ...
                        <select name="branch_id">
                            ...
                            <?php $selected = (int) old('branch_id', $enquiry->branch_id ?? 0); ?>
                    ...
                    <label class="field">
                        ...
                        <select name="owner_user_id">
                            ...
                            <?php $selected = (int) old('owner_user_id', $enquiry->owner_user_id ?? 0); ?>
