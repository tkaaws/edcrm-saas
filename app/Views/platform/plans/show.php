...
<section class="module-page">
    ...
    <div class="detail-grid">
        ...
        <div class="detail-card">
            <h3 class="detail-card__title">Pricing (INR)</h3>
            <?php
                $monthlyPrice = null;
                $yearlyPrice  = null;
            ...
            <div class="detail-card__row">
                ...
                <form method="post" action="<?= site_url("platform/plans/{$plan->id}/price") ?>" class="inline-form">
                    ...
                    <button type="submit" class="shell-button shell-button--sm">Save</button>
                </form>
            </div>
        ...
        <!-- LIMITS -->
        <div class="detail-card">
            <h3 class="detail-card__title">Capacity Limits</h3>
                ...
                <div class="detail-card__row">
                    ...
                    <form method="post" action="<?= site_url("platform/plans/{$plan->id}/limit") ?>" class="inline-form">
                        ...
                        <input type="number" name="limit_value" class="shell-input shell-input--sm"
                               ...
                               placeholder="-1=∞" min="-1" step="1" style="width:80px">
                        <button type="submit" class="shell-button shell-button--sm">Save</button>
                    </form>
                </div>
            <?php endforeach; ?>
        ...
        <div class="detail-card detail-card--wide">
            <h3 class="detail-card__title">Module Entitlements</h3>
