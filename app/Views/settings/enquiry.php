...
<section class="module-page">
    <div class="module-toolbar">
        <div>
            <h2 class="module-title">Enquiry Settings</h2>
            <p class="module-subtitle">Keep enquiry access simple: only the owner, assigned branches, or the full company.</p>
        </div>
        <a class="shell-button shell-button--ghost" href="<?= site_url('settings') ?>">Back to settings</a>
    </div>
