...
$routes->group('enquiries', ['filter' => ['auth', 'tenant', 'suspension', 'feature:crm_core']], static function (RouteCollection $routes): void {
    ...
    $routes->post('(:num)/contact', 'Enquiries::updateContactInfo/$1', ['filter' => 'privilege:enquiries.edit']);
    $routes->post('(:num)/college', 'Enquiries::updateCollegeInfo/$1', ['filter' => 'privilege:enquiries.edit']);
